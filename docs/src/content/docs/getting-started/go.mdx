...
Phase 3 scaffold. Interfaces and types compile; the CLI and reference daemon are in active development. See the [Go SDK README](https://github.com/jeffs-brain/memory/tree/main/sdks/go) for the current implementation state.

## Next steps

- [Concepts](/concepts/brains/).
- [MCP integration](/mcp/claude-code/) (TypeScript wrapper today, Go wrapper in flight).
