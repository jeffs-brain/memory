 ...
 *
 * Semantics invented for this adapter:
 ...
 *     (`kind: 'service'`, `id: 'workspace:<id>'` and so on). We expose a
 *     helper `parentTuple` to make that readable from callers.
 ...
 * in-memory `Map`, but consumers can back it with SQLite or anything else
 * by implementing this type.
 */
