...
/**
 * Shared rerank concurrency gate. Multiple reranker instances in the
 * same process reuse the same gate for a given configured cap so TEI
 * probes, cross-encoder calls, and LLM rerank batches do not stampede
 * the same backend.
 */
