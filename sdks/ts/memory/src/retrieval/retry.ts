...
const STOP_WORDS: ReadonlySet<string> = new Set([
  'the', 'a', 'an', 'and', 'or', 'but', 'is', 'are', 'was', 'what',
  'who', 'when', 'where', 'why', 'how', 'you', 'for', 'from',
  'about', 'advice', 'any', 'been', 'can', 'choose', 'current', 'decide',
  'deciding', 'feeling', 'find', 'getting', 'help', 'helpful', 'idea',
  'ideas', 'interesting', 'ive', 'look', 'looking', 'make', 'making',
  'might', 'need', 'needs', 'noticed', 'planning', 'recent', 'recently',
  'recommend', 'recommendation', 'recommendations', 'should', 'some',
  'soon', 'suggest', 'suggestion', 'suggestions', 'sure', 'thinking',
  'tips', 'together', 'trying', 'upcoming', 'useful', 'want', 'weekend',
  'with', 'would', 'again', 'becoming', 'bit', 'combined', 'having',
  'items', 'keep', 'keeping', 'kind', 'kinds', 'lately', 'many', 'seen',
  'show', 'tonight', 'trouble', 'type', 'types', 'watch',
  'have', 'has', 'had',
  'de', 'het', 'een', 'en', 'of',
])
